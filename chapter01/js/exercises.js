...
// var permute = function (expr) {
//   // list is down to just one term
//   if (expr.length === 1) {
//     return expr[0];
//   }
//   // try with left paren
...
Exercises.strings5 = function () {
  ...
  return "super" + "califragilistic" + "expialidocious";
...
Exercises.coercion7 = function () {
  ...
  return 0 + "0" +  false + undefined + null !== isNaN;
